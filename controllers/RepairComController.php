...
use culturePnPsu\material\models\RepairComSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RepairComController implements the CRUD actions for Repair model.
 */
class RepairComController extends Controller
{
    ...
    {
        $searchModel = new RepairComSearch();
