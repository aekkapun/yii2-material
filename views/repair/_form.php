...
<div class="row">
    <div class="col-sm-12">
        ...
        <?=
        $form->field($model, 'material_id')->widget(MaskedInput::className(), [
            'mask' => [
                '999-99-999-99/j-9{1,2}/9{1,2}',
                'ศต.7110-9{1,3}-9{1,3}-9{1,2}/9{1,2}-9{1,2}/j',
                'ศต.711-9{1,3}-9{1,3}-9{1,2}/9{1,2}',
                'ศต.9.9-9{1,2}',
                'สว.9999-9{1,3}-9{1,3}-9{1,2}/9{1,2}-9{1,2}/j',
                'สว.999-9{1,3}-9{1,3}-99/j-9{1,2}/9{1,2}',
